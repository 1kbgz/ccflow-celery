...
lint-py:  ## lint python with ruff
	python -m ruff check ccflow_celery
	python -m ruff format --check ccflow_celery
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix ccflow_celery
	python -m ruff format ccflow_celery
...
test:  ## run python tests
	python -m pytest -v ccflow_celery/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v ccflow_celery/tests --cov=ccflow_celery --cov-report term-missing --cov-report xml
